...
class ViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        ClientIpTextField.stringValue = "192.168.1.10"
...
//        let port = ServerPortTextField.stringValue.toInt()! == nil ? ServerPortTextField.stringValue.toInt()! : 0
//        tcpService.initInputStream(port)
    }
}
